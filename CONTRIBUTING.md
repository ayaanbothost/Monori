...
Before starting large features, open an issue or discuss in the [support server](https://discord.gg/hfJfrrb6YS) so we can align on scope and avoid duplicate work.
